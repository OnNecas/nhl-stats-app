...
Return **only** the raw SQL query **without any formatting**, backticks, or explanation.
Do **not** wrap the query in triple backticks (```), and do **not** include the word 'sql'.
Important: Return 10 records and not only the top one!
...
Without the first intro message, go directly to the reply. Go directly to the ponint and be short and clear.
